...
def process_data():
    """
    Process base data, not including NDLS feature enhancement
    NDLS feature generation will be performed within each fold
    """
    ...
    print("Processing similarity graphs...")
    drdr_graph, didi_graph = process_similarity_graph(d_data, args)

    print("Base data processing completed.")
    print(f"Drugs: {d_data['drug_number']}, Diseases: {d_data['disease_number']}, Proteins: {d_data['protein_number']}")
